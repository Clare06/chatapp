...
import { ForgotPassReq } from 'src/app/data/schemas/forgotPassReq';
import { NewPass } from 'src/app/data/schemas/newPass';
import { Otp } from 'src/app/data/schemas/otp';
...
export class ForgotPasswordComponent {
  ...
  constructor(private fb: FormBuilder, private http:HttpClient, private router: Router) {
    ...
    ngOnInit() {
      if (typeof PupilMovement !== 'undefined') {
        PupilMovement.init();
      }
    }
